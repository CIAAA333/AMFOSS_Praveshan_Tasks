...
class Dashboard(QWidget):
    ...
    def execute_search(self):
        ...
        mycon = mysql.connector.connect(host="localhost", user="root", password="ciamaths100", database="cinescope_db")
        cursor = mycon.cursor()
    ...
    def export_csv(self):
        ...
        with open("/home/cia-n-s/csv_export.csv", "w", newline="", encoding="utf-8") as fh:
        ...
        self.output_console.append("Data Exported Successfully: /home/cia-n-s/csv_export.csv")
